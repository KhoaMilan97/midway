        ...
        <main>
          ...
          <div className="container margin_60">
            <div className="main_title">
              ...
              <br />
              <p>
                Cung cấp dịch vụ du lịch chất lượng, tin cậy, cho phép khách
                hàng đặt những chuyến đi hoàn hảo.
              </p>
            </div>
            <div className="row">
            ...
            <div className="row">
              <div className="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div className="feature">
                  ...
                  <p>
                    ĐỘi ngũ nhân viên hỗ trợ 24/7 giúp giải đáp thắc mắc cũng
                    như giải quyết vấn đề nhanh chóng.
                  </p>
                </div>
              </div>
              <div className="col-lg-6 wow fadeIn" data-wow-delay="0.6s">
                <div className="feature">
                  ...
                  <p>
                    Công ty cho phép bạn mang theo thú cưng trên hành trình để
                    đảm bảo mang lại trải nghiệm tốt nhất.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="review_strip">
                  ...
                  <p>
                    ...
                    vui vẻ, thân thiện, có duyên. Nếu có dịp chúng tôi sẽ còn
                    quay lại với Midway."
                  </p>
              ...
              <div className="col-lg-6">
                <div className="review_strip">
                  ...
                  <p>
                    "Vừa rồi mình có liên hệ và được bạn Mai Lê tư vấn mua vé
                    máy bay từ TP. HCM đến Phú Quốc và Phú Quốc về TP.HCM, mình
                    rất hài lòng. Mai Lê hướng dẫn chi tiết và rất nhiệt tình,
                    giá vé lại hợp lý. Cám ơn Mai Lê và Công ty! Hứa hẹn sẽ gặp
                    lại trong nhiều ngày gần nhất!!!"
                  </p>
                  <div className="rating">
                    <i className="icon-star voted" />
                    <i className="icon-star voted" />
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="review_strip">
                  ...
                  <p>
                    "Mình cũng mới dùng Midway lần đầu nhưng thấy nhân viên
                    nhiệt tình và có trách nhiệm. Bạn Hoàng Thị Lý đã làm rất
                    tốt phần tư vấn Vinpearl và cả phần thay đổi cho người ít
                    trải nghiệm như mình. Cảm ơn em Lý và chúc em cùng Công ty
                    phát triển tốt. Hẹn gặp lại và sẽ giới thiệu cho mọi người."
                  </p>
                  <div className="rating">
                    <i className="icon-star voted" />
                    <i className="icon-star voted" />
              ...
              <div className="col-lg-6">
                <div className="review_strip">
                  ...
                  <p>
                    ...
                    Nguyễn và các nhân viên Midway nhiệt tình, mình sẽ tiếp tục
                    sử dụng dịch vụ bên MIdway trong thừi gian tới."
                  </p>
                  <div className="rating">
                    <i className="icon-star voted" />
                    <i className="icon-star voted" />

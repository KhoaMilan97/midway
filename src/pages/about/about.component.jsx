        ...
        <div className="row">
          ...
          <div className="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
            <div className="feature">
              ...
              <p>
                Với danh sách tour du lịch đa dạng đảm bảo phục vụ tốt nhất với
                những chuyến đi của khách hàng.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <p>
              ...
              thiết kế theo yêu cầu cho khách đoàn trên các tuyến điểm tại Việt
              Nam.{" "}
            </p>
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="review_strip">
              ...
              <p>
                "Tôi đã đi tour 5N4Đ Nha Trang từ 04/07 đến 08/07. Nhóm gia đình
                chúng tôi 12 người (cả đoàn là 20 người) nói chung cảm nhận rất
                tuyệt với cách tổ chức của các bạn, cảm ơn bạn HDV Long đã cùng
                đoàn từ HCM sang suốt hành trình đến khi về an toàn &amp; vui vẻ
                nhiệt tình. 2 Bạn HDV ở Nha Trang cũng rất vui vẻ, thân thiện,
                có duyên. Nếu có dịp chúng tôi sẽ còn quay lại với Midway."
              </p>
          ...
          <div className="col-lg-6">
            <div className="review_strip">
              ...
              <p>
                ...
                bay từ TP. HCM đến Phú Quốc và Phú Quốc về TP.HCM, mình rất hài
                lòng. Mai Lê hướng dẫn chi tiết và rất nhiệt tình, giá vé lại
                hợp lý. Cám ơn Mai Lê và Công ty! Hứa hẹn sẽ gặp lại trong nhiều
                ngày gần nhất!!!"
              </p>
              <div className="rating">
                <i className="icon-star voted" />
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="review_strip">
              ...
              <p>
                ...
                tình và có trách nhiệm. Bạn Hoàng Thị Lý đã làm rất tốt phần tư
                vấn Vinpearl và cả phần thay đổi cho người ít trải nghiệm như
                mình. Cảm ơn em Lý và chúc em cùng Công ty phát triển tốt. Hẹn
                gặp lại và sẽ giới thiệu cho mọi người."
              </p>
              <div className="rating">
                <i className="icon-star voted" />
                <i className="icon-star voted" />
          ...
          <div className="col-lg-6">
            <div className="review_strip">
              ...
              <p>
                "Rất cảm ơn midway về dịch vụ của các bạn. Tôi đánh giá cao chất
                lượng phục vụ. Giá cả hợp lý, Nhân viên tư vấn Quỳnh Nguyễn và
                các nhân viên Midway nhiệt tình, mình sẽ tiếp tục sử dụng dịch
                vụ bên MIdway trong thừi gian tới."
              </p>
              <div className="rating">
                <i className="icon-star voted" />
                <i className="icon-star voted" />

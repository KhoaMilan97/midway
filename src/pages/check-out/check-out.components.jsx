        ...
        <div className="row">
          <div className="col-lg-8 add_bottom_15">
            ...
            <div className="step">
              ...
              <p>
                Lorem ipsum dolor sit amet, vim id accusata sensibus, id ridens
                quaeque qui. Ne qui vocent ornatus molestie, reque fierent
                dissentiunt mel ea.
              </p>
              <p>
                <img src="img/paypal_bt.png" alt="paypal" />
              </p>
            </div>
            {/*End step */}
            <div className="form_title">
          ...
          <aside className="col-lg-4">
            <div className="box_style_1">
              ...
              <Link className="btn_full" to="/confirm">
                Book now
              </Link>
              <Link className="btn_full_outline" to="/tours">
            ...
            <div className="box_style_4">
              ...
              <Link to="tel://004542344599" className="phone">
                +45 423 445 99
              </Link>
